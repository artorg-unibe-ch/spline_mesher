...
import futils.structure as structure


class FilePathGenerator(metaclass=abc.ABCMeta):
    """Represents an abstract file path generator.

    This class is used in :py:class:`FileSystemDataCrawler` to convert a human readable data identifier to a
...
class BoneImageFilePathGenerator(FilePathGenerator):
    """Represents a bone image file path generator.
    ...
    def __init__(self):
        """Initializes a new instance of the BoneImageFilePathGenerator class."""
        pass
    ...
    def get_full_file_path(id_: str, root_dir: str, file_key, file_extension: str) -> str:
        ...
        if file_key == structure.BoneImageTypes.CortMask:
            file_name = 'CorticalMask'
        elif file_key == structure.BoneImageTypes.TrabMask:
            file_name = 'Trabecular Mask'
...
class FileSystemDataCrawler:
    ...
    Examples:
        Suppose we have the following directory structure::
            ...
            /path/to/root_dir
                ...
                ./Patient2
                    ...
                    ./CortMask.mhd
                    ./TrabMask.mhd
                    ./GroundTruthRater2.mhd
                ./Atlas
                    ./Atlas.mhd

        We can use the following code to load the images `Image.mhd` and `GroundTruth.mhd`
        ...
        Patient1 {'Patient1': '/path/to/root_dir/Patient1',
                  <MyImgType.T1: 1>: '/path/to/root_dir/Patient1/Image.mhd',
                  <MyImgType.GroundTruth: 2>: '/path/to/root_dir/Patient1/GroundTruth.mhd'}
        Patient2 {'Patient2': '/path/to/root_dir/Patient2',
                  <MyImgType.T1: 1>: '/path/to/root_dir/Patient2/Image.mhd',
                  <MyImgType.GroundTruth: 2>: '/path/to/root_dir/Patient2/GroundTruth.mhd'}
    """
