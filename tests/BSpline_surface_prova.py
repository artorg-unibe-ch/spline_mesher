...
if method == 1:
    ...
    gmsh.model.occ.fragment(
        gmsh.model.occ.getEntities(0), gmsh.model.occ.getEntities(2)
    )
...
gmsh.write(
    "/home/simoneponcioni/Documents/01_PHD/03_Methods/Meshing/Meshing/99_testing_prototyping/BSplineSurface/test01.geo_unrolled"
)
gmsh.finalize()
